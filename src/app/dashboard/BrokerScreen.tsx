...
export default function BrokerScreen({ user }: BrokerScreenProps) {
  ...
  const stats = {
    quotesEnCours: quotes.filter(q => q.status === "IN_PROGRESS" || q.status === "SUBMITTED").length,
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Bienvenue {user.name} ({user.companyName}), gérez vos devis et contrats d'assurance
            </p>
          </div>
        ...
        <div className="p-6">
          ...
          {activeTab === "contracts" && (
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">Gestion des contrats</h3>
          ...
          {activeTab === "commissions" && (
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">Suivi des commissions</h3>
              <p className="mt-1 text-sm text-gray-500">
          ...
          {activeTab === "notifications" && (
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">Messages et notifications</h3>
              <p className="mt-1 text-sm text-gray-500">
